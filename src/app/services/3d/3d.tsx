...
function Cgi() {
  return (
    <div>
        ...
        <Runninglogo/>
        <h1 className='text-center lg:text-5xl md:text-3xl text-xl lg:py-15 md:py-10 py-4 font-semibold' data-aos="fade-up">Photorealistic CGI</h1>
        <div className='lg:px-30 md:px-10 px-4 grid md:grid-cols-2 grid-cols-2 md:gap-4 gap-2'>
            <div data-aos="fade-right" style={{ backgroundImage: "url('https://designedbypelago.com/wp-content/uploads/2025/09/hero.png')" }} className='relative bg-cover bg-center md:h-[30vh] h-[20vh] rounded-[15px]'>
            ...
            <div data-aos="fade-left" style={{ backgroundImage: "url('https://designedbypelago.com/wp-content/uploads/2025/09/hero2.png')" }} className='relative bg-cover bg-center md:h-[30vh] h-[20vh] rounded-[15px]'>
                <div className="absolute inset-0 bg-black/70 z-0 rounded-[15px]" />  {/* overlay hitam transparan */}
                <div className='relative text-center text-white lg:text-3xl md:text-xl text-base font-semibold top-1/2 -translate-y-1/2 px-2'>
                    <h1 className='mb-5'>
            ...
            <div data-aos="fade-right" style={{ backgroundImage: "url('https://designedbypelago.com/wp-content/uploads/2025/09/service.png')" }} className='relative bg-cover bg-center md:h-[30vh] h-[20vh] rounded-[15px]'>
                <div className="absolute inset-0 bg-black/70 z-0 rounded-[15px]" />  {/* overlay hitam transparan */}
                <div className='relative text-center text-white lg:text-3xl md:text-xl text-base font-semibold top-1/2 -translate-y-1/2 px-2'>
                    <h1 className='mb-5'>
        ...
        <h1 className='text-center lg:text-5xl md:text-3xl text-xl lg:py-15 md:py-10 py-4 lg:mt-15 md:mt-10 mt-4 font-semibold bg-[#f5f4ea]' data-aos="fade-up"> Landscape Animation</h1>
        <div className='lg:px-30 md:px-10 px-4 lg:pb-15 md:pb-10 pb-4 grid md:grid-cols-2 grid-cols-2 md:gap-4 gap-2 bg-[#f5f4ea]'>
            <div data-aos="fade-right" style={{ backgroundImage: "url('https://designedbypelago.com/wp-content/uploads/2025/09/hero.png')" }} className='relative bg-cover bg-center md:h-[30vh] h-[20vh] rounded-[15px]'>
                <div className="absolute inset-0 bg-black/70 z-0 rounded-[15px]" />  {/* overlay hitam transparan */}
                <div className='relative text-center text-white lg:text-3xl md:text-xl text-base font-semibold top-1/2 -translate-y-1/2 px-2'>
                    <h1 className='mb-5'>
