...
function EbdPage() {
  return (
    <div className='overflow-hidden'>
        <Navbar/>
        <div 
        style={{ backgroundImage: "url('./ebd-studios/photos/1.jpg')" }}
        ...
        <div className='grid lg:grid-cols-2 md:gap-8 gap-4 items-center lg:px-30 md:px-10 px-4 lg:py-15 md:py-10 py-4'>
            <div data-aos="fade-right">
                <h1 className='lg:text-xl md:text-lg text-sm lg:text-start text-center'>EBD Studios is a Colorado-based design studio focused on high-end residential and exterior environments. With a clean, refined aesthetic and site-sensitive approach, their projects blend modern form with natural materiality. We support EBD by producing photorealistic imagery and animations that strengthen both the client experience and their broader brand presentation.</h1>
            </div>
