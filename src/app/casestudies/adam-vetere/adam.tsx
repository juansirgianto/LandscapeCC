...
function AdamPage() {
  return (
    <div className='overflow-hidden'>
        <Navbar/>
        <div style={{ backgroundImage: "url('./photos/1.jpg')" }} className='relative bg-cover bg-center md:h-[100vh] h-[50vh] mt-[73px] md:mt-0 lg:px-50 md:px-10 px-4' data-aos="fade-right">
          ...
          <div className='relative text-center text-white md:text-5xl text-3xl font-semibold top-1/2 -translate-y-1/2 md:px-0 px-2'>
            <h1 className='mb-5'>
            Adam Vetere <br /> Landscape & Garden Design
            </h1>
          </div>
        </div>
        <div className='grid lg:grid-cols-2 md:gap-8 gap-4 items-center lg:px-30 md:px-10 px-4 lg:py-15 md:py-10 py-4'>
            <div data-aos="fade-right">
                <h1 className='lg:text-xl md:text-lg text-sm lg:text-start text-center'>Adam Vetere's studio is known for elegant, emotive garden designs that blend structure and softness. With a focus on composition, texture, and layered beauty, his award-winning landscapes are widely recognised in the UK and internationally.</h1>
            </div>
            <div className='flex flex-col justify-between h-full md:gap-5 gap-3'>
                ...
                <h1 className='text-center lg:text-lg md:text-base text-xs rounded-full p-2 text-white bg-gradient-to-t from-[#757741] to-[#d3d2a5] col-span-2' data-aos="fade-up">2D Drafting & Technical Drawings</h1>
                </div>
            </div>
        </div>
