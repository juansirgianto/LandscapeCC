...
function AboutPage() {
  return (
    <div className='overflow-hidden'>
        ...
        <Runninglogo/>
        <div className='mx-auto text-center lg:px-30 md:px-10 px-4' data-aos="fade-left">
            ...
            <a href="#explore">
            <Button className="lg:text-2xl md:text-xl text-xs rounded-full relative items-center bg-[#757741] md:!p-7 !p-5 cursor-pointer hover:bg-[#d3d2a5] hover:text-[#757741]">
        ...
        <div className='lg:px-30 lg:py-15 md:p-10 p-4 lg:mt-15 md:mt-10 mt-4 lg:gap-8 md:gap-4 items-center bg-[#d3d2a5]' data-aos="fade-up">
            <h1 className='lg:text-3xl md:text-xl text-lg font-semibold mb-4 text-center md:text-start'>What Sets Us Apart :</h1>
        ...
        <AccordionItem value="item-1">
            <AccordionTrigger className='lg:text-3xl md:text-2xl text-lg font-semibold cursor-pointer'>We Serve Landscape Professionals In :</AccordionTrigger>
        ...
        <div className='lg:px-30 lg:py-15 md:p-10 p-4'>
            <h1 className='lg:text-5xl md:text-3xl text-xl font-semibold mb-2' data-aos="fade-up">Meet The Studio</h1>
        ...
        <div style={{ backgroundImage: "url('https://designedbypelago.com/wp-content/uploads/2025/10/1577CC_PWGD_POOL_REV-01-Photo.jpg')" }} className='relative md:h-[80vh] h-[50vh] bg-center bg-cover' data-aos="fade-up">
            ...
            <div className='relative text-center text-white lg:text-4xl md:text-2xl font-semibold top-1/2 -translate-y-1/2 lg:px-30 md:px-10 px-4'>
